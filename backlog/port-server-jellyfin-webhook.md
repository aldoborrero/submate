...
## what
Port `/jellyfin/webhook`: validate User-Agent, filter ItemAdded, resolve the file path, run the skip decision, and enqueue a file-transcription job (fire-and-forget; a node drains it).
