...
//! `submate/cli/commands/transcribe.py`).
//!
...
mod parity {
    ...
    ///
    /// `rust/fixtures/cli/transcribe_collect_cases.json` is a list of
    ...
    ///
    /// `rust/fixtures/cli/transcribe_supported_extensions.json` holds the Python
