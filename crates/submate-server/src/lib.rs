...
/// `docs/architecture.md`): job counts by lifecycle state plus the number
...
/// `docs/architecture.md`: nodes register, long-poll [`request_work`] for an
...
/// `docs/architecture.md`): node lifecycle (`register`, `request-work`,
